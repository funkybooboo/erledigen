/**
 * RecurringTaskRepository contract tests (see ADR-003)
 *
 * The same suite runs against every RecurringTaskRepository implementation
 * (InMemoryRecurringTaskRepository, SqliteRecurringTaskRepository) to
...
export function runRecurringTaskRepositoryContractTests(
    makeRepo: () => RecurringTaskRepository,
): void {
    describe('create', () => {
