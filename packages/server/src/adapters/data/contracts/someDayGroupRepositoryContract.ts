/**
 * SomeDayGroupRepository contract tests (see ADR-003)
 *
 * The same suite runs against every SomeDayGroupRepository implementation
 * (InMemorySomeDayGroupRepository, SqliteSomeDayGroupRepository) to guarantee
 * behavioral parity.
 */
...
export function runSomeDayGroupRepositoryContractTests(
    makeRepo: () => SomeDayGroupRepository,
): void {
    describe('create', () => {
